...
})(
  {
        ...
        var n = function(e) {
          ...
          for (
            ...
            if ('coordinates' === l) {
              ...
              (c.className = 'marker'),
                new mapboxgl.Marker({ element: c, anchor: 'bottom' })
                  .setLngLat(p)
                  .addTo(o),
                new mapboxgl.Popup({ offset: 30 })
                  .setLngLat(p)
                  .setHTML('<p>'.concat(p, '</p>'))
                  .addTo(o),
                r.extend(p);
            }
          }
                ...
                function(t) {
                  for (;;)
                    switch ((t.prev = t.next)) {
                      ...
                      case 3:
                        'success' === t.sent.data.status && location.reload(),
                          (t.next = 10);
                        break;
                      case 7:
                        (t.prev = 7),
    ...
    Uj2q: [
      function(require, module, exports) {
        ...
        var s = Stripe('pk_test_7kIfrMr48m4E45AnXSpYXFeO00aiSUQbnV'),
          i = (function() {
            var t = o(
    ...
    Focm: [
      function(require, module, exports) {
        ...
        var i = document.getElementById('map'),
          ...
          l = document.getElementById('book-event');
        if (i) {
          var a = JSON.parse(i.dataset.locations);
          (0, e.displayMap)(a);
        }
        c &&
          ...
          d && d.addEventListener('click', r.logout),
          m &&
          ...
          l &&
            l.addEventListener('click', function(e) {
              ...
              var r = e.target.dataset.placeId;
              (0, o.bookEvent)(r);
            });
      },
      {
