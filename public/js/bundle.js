...
})(
  {
      ...
      function(require, module, exports) {
        ...
        var displayMap = function displayMap(locations) {
          ...
          var map = new mapboxgl.Map({
            ...
            scrollZoom: false,
            maxZoom: 18 // center: [2.302817, 48.796338],
            // zoom: 10,
            // interactive: false
          });
          ...
          for (
            var _i = 0, _Object$entries = Object.entries(locations);
            _i < _Object$entries.length;
            _i++
          ) {
            var _Object$entries$_i = _slicedToArray(_Object$entries[_i], 2),
              key = _Object$entries$_i[0],
              loc = _Object$entries$_i[1];

            if (key === 'coordinates') {
              var coordinates = loc; // Create marker
              ...
              new mapboxgl.Popup({
                ...
                .setLngLat(coordinates)
                .setHTML('<p>'.concat(coordinates, '</p>'))
                .addTo(map); // Extend the map bounds to include location
                      ...
                      switch ((_context.prev = _context.next)) {
                        case 0:
                          ...
                          return (0, _axios.default)({
                            method: 'POST',
                            // Dev url
                            // url: 'http://127.0.0.1:3210/api/v1/users/login',
                      ...
                      switch ((_context2.prev = _context2.next)) {
                        case 0:
                          ...
                          return (0, _axios.default)({
                            method: 'GET',
                            // Dev url
                            // url: 'http://127.0.0.1:3210/api/v1/users/logout'
    ...
    'stripe.js': [
      function(require, module, exports) {
        ...
        var stripe = Stripe('pk_test_7kIfrMr48m4E45AnXSpYXFeO00aiSUQbnV');
                      ...
                      switch ((_context.prev = _context.next)) {
                        case 0:
                          ...
                          return (0, _axios.default)(
                            ...
                            '/api/v1/bookings/checkout-session/'.concat(placeId)
                          );
    ...
    'index.js': [
      function(require, module, exports) {
        ...
        var bookBtn = document.getElementById('book-event'); // Values
        // Delegation
