...
exports.login = catchAsync(async (req, res, next) => {
  ...
  // 2) Check if user exists and pass correct
...
exports.protect = catchAsync(async (req, res, next) => {
  ...
  if (!currentUser) {
    return next(
      new AppError('The token belongs to an user which no longer exists', 401)
    );
  }
...
exports.restrictTo = (...roles) => {
  return (req, res, next) => {
    // roles is an array --> ['admin', 'guide']. role='user'
